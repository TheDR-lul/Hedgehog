...
use crate::webservice_hedge::hedge_logic::helpers::{calculate_limit_price_for_leg, round_down_step, get_current_price, send_progress_update}; // Используем хелперы
